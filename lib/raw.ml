...
external set_adaptive_rho_interval : settings -> int -> unit = "stub_set_adaptive_rho_interval"
external get_adaptive_rho_interval : settings -> int         = "stub_get_adaptive_rho_interval"

external set_adaptive_rho_tolerance : settings -> float -> unit = "stub_set_adaptive_rho_tolerance"
external get_adaptive_rho_tolerance : settings -> float         = "stub_get_adaptive_rho_tolerance"

external set_adaptive_rho_fraction : settings -> float -> unit = "stub_set_adaptive_rho_fraction"
external get_adaptive_rho_fraction : settings -> float         = "stub_get_adaptive_rho_fraction"
...
external set_polish_refine_iter : settings -> int -> unit = "stub_set_polish_refine_iter"
external get_polish_refine_iter : settings -> int         = "stub_get_polish_refine_iter"

external set_verbose : settings -> int -> unit = "stub_set_verbose"
external get_verbose : settings -> int         = "stub_get_verbose"

external set_scaled_termination : settings -> int -> unit = "stub_set_scaled_termination"
external get_scaled_termination : settings -> int         = "stub_get_scaled_termination"

external set_check_termination : settings -> int -> unit = "stub_set_check_termination"
...
external create :
  ...
  int -> (* m   *)
  t option
  = "bc_stub_create" "nat_stub_create"
